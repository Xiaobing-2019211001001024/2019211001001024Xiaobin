		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.XiaoBing.model.Order o=(com.XiaoBing.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.XiaoBing.dao.UserDao userDao=new com.XiaoBing.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.XiaoBing.model.Payment.findByPaymentId(con,n);
						%>
